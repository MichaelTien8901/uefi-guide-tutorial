...
|:--------|:--------|:------------|:-----------|
| **[24. Shell Command]({% link part5/24-shell-command.md %})** | Custom Shell Command | Argument parsing, help text, output formatting | ShellPkg, ShellLib |
| **[25. Boot Menu]({% link part5/25-boot-menu.md %})** | Graphical Boot Menu | Visual boot selector with keyboard navigation | GOP, input, boot options |
| **[26. Network App]({% link part5/26-network-app.md %})** | Network Application | HTTP client and network diagnostics | TCP4, HTTP, DNS |
| **[27. Boot Loader]({% link part5/27-boot-loader.md %})** | Custom Boot Loader | Load and execute kernel images | File I/O, ExitBootServices |
