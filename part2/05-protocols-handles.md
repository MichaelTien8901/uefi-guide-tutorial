...
{: .note }
> **Source Code**: See [`examples/UefiGuidePkg/ProtocolExample/`](https://github.com/MichaelTien8901/uefi-guide-tutorial/tree/main/examples/UefiGuidePkg/ProtocolExample) for complete examples.
